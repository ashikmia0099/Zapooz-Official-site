    ...
    <div className='bg-[#191919]'>
          <div className='max-w-[1596px] mx-auto h-full lg:h-[624px] bg-[url(/images/heroimages/OurService.png)] bg-no-repeat bg-cover'>
            ...
            <div className=' flex items-center justify-center pb-14'>
                <button className=' h-16 w-44 bg-[#9EFF00] rounded-[8px] shadow-2xs border-none text-lg font-medium'>Start Project</button>
              </div>
              <h3 className={`text-[${barlow.className}] text-3xl  lg:text-5xl font-semibold text-center text-white px-4`}>Let us Bring your Ideas to Life in the Digital World.</h3>
