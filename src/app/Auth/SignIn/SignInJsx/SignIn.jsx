        ...
        <div className=' flex-row items-center pt-10'>
            ...
            <div className=' text-center '>
                ...
                <p className=' text-xl py-4'>
                    ...
                    <span className='  mx-6  border-b border-[#2572e7] font-semibold'><Link href="/Auth/SignUP">Sign Up</Link></span>
                </p>
            </div>
            <div className=' w-[60%] mx-auto' >
                <form action="" onSubmit={handleSignIn}>
                    <div className=' mt-2'>
                        ...
                        <input type="email" name='email' placeholder="Enter your email" className="input w-full rounded-full" />
                    </div>
                    <div className=' mt-2'>
                ...
                <div >
                    <SocialSignUpSignIn></SocialSignUpSignIn>
                </div>
            </div>
        </div>
    )
